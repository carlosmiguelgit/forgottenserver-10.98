...
//Outfits storage range within reserved range
static constexpr int32_t PSTRG_OUTFITS_RANGE_START = 10000000;
static constexpr int32_t PSTRG_OUTFITS_RANGE_SIZE = 10000;
